(() => {
  ...
  const copy = {
    pl: {
      ...
      points: [
        "zgłoś błąd lub coś, co nie działa prawidłowo",
        "wyślij propozycję nowej funkcji lub usprawnienia",
        "zadaj pytanie dotyczące działania aplikacji",
        "prześlij inną uwagę lub sugestię"
      ],
    ...
    no: {
      badge: "NY FUNKSJON",
      title: "Informasjon og kontakt med appens utvikler",
      ...
      points: [
        "rapporter en feil eller noe som ikke fungerer som det skal",
        "send forslag til en ny funksjon eller forbedring",
        "still spørsmål om hvordan appen fungerer",
        "send en annen kommentar eller idé"
      ],
    ...
    en: {
      badge: "NEW FEATURE",
      title: "Information and contact with the app creator",
      ...
      points: [
        "report a bug or something that is not working correctly",
        "suggest a new feature or improvement",
        "ask a question about how the app works",
        "send another comment or suggestion"
      ],
    ...
    de: {
      badge: "NEUE FUNKTION",
      title: "Informationen und Kontakt zum App-Ersteller",
      ...
      points: [
        "einen Fehler oder eine nicht funktionierende Funktion melden",
        "eine neue Funktion oder Verbesserung vorschlagen",
        "eine Frage zur Bedienung der App stellen",
        "einen anderen Hinweis oder Vorschlag senden"
      ],
  ...
  function language() {
    const value = String(document.documentElement.lang || localStorage.getItem("europris_language_v6") || "pl").toLowerCase();
  ...
  function show() {
    ...
    dialog.className = "europris-startup-info";

    const card = document.createElement("div");
    card.className = "europris-startup-card";

    const badge = document.createElement("div");
    badge.className = "europris-startup-badge";
    ...
    note.className = "europris-startup-note";
    note.textContent = t.note;

    const choice = document.createElement("label");
    choice.className = "europris-startup-choice";
    const checkbox = document.createElement("input");
    checkbox.type = "checkbox";
    const choiceText = document.createElement("span");
    choiceText.textContent = t.dontShow;
    choice.append(checkbox, choiceText);

    const close = document.createElement("button");
    close.type = "button";
    close.className = "europris-startup-close";
    close.textContent = t.close;

    close.addEventListener("click", () => {
      if (checkbox.checked) rememberDismissal();
      dialog.close();
      dialog.remove();
    });

    card.append(badge, title, text, list, note, choice, close);
